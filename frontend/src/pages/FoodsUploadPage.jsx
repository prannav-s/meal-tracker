        ...
        <div className='card border border-base-content/10 bg-base-100 shadow-sm'>
          <div className='card-body space-y-6'>
            <div className='space-y-2 text-center sm:text-left'>
              <h1 className='text-2xl font-bold text-primary'>Scan a nutrition label</h1>
              <p className='text-sm text-base-content/70'>
                Upload a clear photo of an ingredients list or nutrition label. We will extract foods for you and add them to your library.
              </p>
            </div>
